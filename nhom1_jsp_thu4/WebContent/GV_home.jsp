                     ...
                     <div class="panel-heading"><h4>Thông Báo</h4></div>
                        ...
                        <div class="panel-body"><!--Các bản tin-->
                            <ul class="list-unstyled" > 
                              ...
                              <a href="tin-tu-giao-vu/thong-bao-dang-ky-de-tai-tot-nghiep-va-hoc-mon-tot-nghiep-khoa-2012-201602251456389427.jsp">
                                  <li class="article-area">
                                      <p>
                                       <li class="active"><a href="#"><i class="glyphicon glyphicon-hand-right"></i>       Thông báo giờ báo cáo tốt nghiệp khoá  </a></li>
                                       </p>
                                       <p>
                                          Thông báo về việc xét cấp học bổng khuyến khích học tập học kỳ I năm học 2016-2017
                                       </p>
                                       <hr  width="100%" size="5px" align="center" /> 
                                  </li>
