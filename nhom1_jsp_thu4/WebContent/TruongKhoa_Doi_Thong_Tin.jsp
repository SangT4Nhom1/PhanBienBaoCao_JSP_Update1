          ...
          <div class="col-md-3">
                <div class="panel panel-primary" style="padding-top:0px">          
                 <div class="panel-body" style="padding-top:15px">
                        ...
                        <li class="active"><a href="TruongKhoa_ThongTin."><i class="glyphicon glyphicon-user"></i>    Thông Tin Cá Nhân</a></li>
            ...
            <div class="col-md-7 well">
              ...
              <div class="panel-heading"><h4>ĐỔI THÔNG TIN TRƯỞNG KHOA</h4></div>
