            ...
            <div class="col-md-9 well">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href=" GV_Danh_Sach_De_Tai_Chi_Tiet.jsp " class="btn btn-info" role="button">Chi Tiết</a>
                  </td>
                </tr>
                <tr>
                  <td>2</td>
                  <td>Lý</td>
                  <td>18/09/2016 15:00</td>
                  <td>Ủy Viên</td>
                  <td>
                    <a href=" GV_Danh_Sach_De_Tai_Chi_Tiet.jsp " class="btn btn-info" role="button">Chi Tiết</a>
                  </td>
              ...
              <div class="form-group" style="text-align: right; padding-top: 10px;padding-bottom: 10px">
                <a href=" GV_home.jsp " class="btn btn-info" role="button"> BACK </a>
              </div>
          </div>  
